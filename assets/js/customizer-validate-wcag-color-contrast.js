 ...
 * global wp, ayinValidateWCAGColorContrastExports
 * global ayinValidateContrastText
...
( function( $, api, exports ) {
	...
	self.addWCAGColorContrastValidation = function( setting ) {
		...
		setting.validate = function (value){
			...
			if ( failsWCAG ){
				var validationWarning = new api.Notification( code, { message: ayinValidateContrastText, type: 'warning' } );
				setTimeout( function(){
...
} )( jQuery, wp.customize, ayinValidateWCAGColorContrastExports );